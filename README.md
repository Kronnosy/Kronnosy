...
Hi there! I'm Kronnosy, a software developer who loves building open-source economies and markets for Minecraft: Bedrock/PocketMine-MP, helping gaming communities establish sustainable systems.

## About Me
- 💼 I design economy and market infrastructures for community servers.
- 🧠 I focus on producing clean, maintainable code with PHP, TypeScript, and automation tools.
- 🌍 I believe in open-source culture and strive to keep code as documented and accessible as possible.
- 🛠️ I enjoy experimenting with new technologies and continuously improving my processes.

## Currently
- 🚀 Working on advanced economy reporting and API support for `Kronnomy`.
